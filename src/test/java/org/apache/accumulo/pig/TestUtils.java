...
public class TestUtils {
    ...
    public static void assertConfigurationsEqual(Configuration expectedConf, Configuration actualConf) {
        ...
        while (expectedIter.hasNext()) {
            ...
            String expected = expectedConf.get(e.getKey());
            String actual = actualConf.get(e.getKey());
            assertEquals(String.format("Configuration different for key: [%s]. Expected [%s]. Actual was [%s]", e.getKey(), expected, actual), expected, actual);
        }
